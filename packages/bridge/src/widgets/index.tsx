...
export async function activateAutomationBridge(plugin: ReactRNPlugin) {
  ...
  await plugin.settings.registerBooleanSetting({
    ...
    description: 'Local kill switch for paired create, journal, and update operations',
  ...
  await plugin.settings.registerBooleanSetting({
    ...
    description: 'Local kill switch for paired destructive child replacement operations',
