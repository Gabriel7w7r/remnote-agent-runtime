...
Do not expose ports `3001`, `3002`, or `8080` through a tunnel, reverse proxy, LAN binding, port forward, or public relay. A future remote mode would require a separately reviewed authenticated gateway and is not part of version `0.19.0`.
